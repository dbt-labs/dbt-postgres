...
from dbt.adapters.postgresrds import PostgresRDSConnectionManager
from dbt.adapters.postgresrds.column import PostgresRDSColumn
from dbt.adapters.postgresrds import PostgresRDSRelation
...
GET_RELATIONS_MACRO_NAME = "postgresrds__get_relations"
...
@dataclass
class PostgresRDSConfig(AdapterConfig):
    unlogged: Optional[bool] = None
    indexes: Optional[List[PostgresIndexConfig]] = None


class PostgresRDSAdapter(SQLAdapter):
    Relation = PostgresRDSRelation
    ConnectionManager = PostgresRDSConnectionManager
    Column = PostgresRDSColumn

    AdapterSpecificConfigs = PostgresRDSConfig
